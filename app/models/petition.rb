class Petition < ActiveRecord::Base
  ...
  attr_accessible :description, :title, :petition_titles_attributes, :petition_images_attributes
  attr_accessible :description, :title, :petition_titles_attributes, :petition_images_attributes, :to_send, :as => :admin
  has_many :signatures
