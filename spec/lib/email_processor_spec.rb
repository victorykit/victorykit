describe EmailProcessor do
  ...
  it "should create a record in bounced_emails table" do
    EmailProcessor.handle_exceptional_email("email_content", "bounce+#{sent_email.to_hash}@appmail.watchdog.net", "bounced")
  ...
  it "should create a record in unsubscribes table if we have a member with such email" do
    EmailProcessor.handle_exceptional_email("email_content", "unsubscribe+#{sent_email.to_hash}@appmail.watchdog.net", "unsubscribe")
